...
import { Loader2, ScrollText, CheckCircle2, XCircle, Circle, Undo2, AlertCircle } from "lucide-react";
import { useGrant, useReportsByGrant, useCloseGrant } from "@/lib/hooks/useEscrivan";
      ...
      {active && grant.rejection_streak > 0 && (
        ...
        >
          ...
          <span>
            ...
            record. At 3 the grant auto-closes and the remaining escrow returns to the funder.
          </span>
        </div>
      )}
